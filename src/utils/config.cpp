...
void Config::setFossibotMAC(const String& mac) {
    _fossibotMAC = mac;
}

void Config::setTheme(const String& theme) {
    _theme = theme;
}

void Config::setAutoSleepMinutes(int minutes) {
    _autoSleepMinutes = minutes;
}

void Config::setTimezoneOffset(int hours) {
    _timezoneOffset = hours;
}

void Config::setWeather(const String& apiKey, const String& city, const String& units) {
